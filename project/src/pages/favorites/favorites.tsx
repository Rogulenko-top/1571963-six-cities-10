              ...
              <ul className="favorites__list">
                <li className="favorites__locations-items">
                  ...
                  <div className="favorites__places">
                    {offersOfAmsterdam.map((element) => <FavoriteOfferCard key={element.id + element.type} offer={element} />)}
                  </div>
                </li>
                ...
                <li className="favorites__locations-items">
                  ...
                  <div className="favorites__places">
                    {offerOfCologne.map((element) => <FavoriteOfferCard key={element.id + element.type} offer={element} />)}
                  </div>
                </li>
              </ul>
            </section>
